...
class BatchedMCTSCoordinator:
    ...
    def play_games(
        ...
        """Play n_games using cross-game batched MCTS.
        ...
        while active_games:
            ...
            # Batch evaluate non-terminals (GPU)
            ...
            # Update simulation counts and check for move/game completion
            games_to_remove = []
            ...
            # Remove completed games and spawn new ones
            ...
            # Re-index pending leaves after game removal (implicit via new collection)
