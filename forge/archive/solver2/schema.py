"""
solver2 Parquet Schema
======================

This module documents the parquet file format produced by solver2 and provides
utilities for loading/decoding the data. Import this instead of reading source.
...
---------------
    ...
    V : int8
        ...
        Positive = team 0 expected to gain more points than team 1.
        At terminal states (all dominoes played), V represents team 0's
        total point advantage from that line of play.

    mv0..mv6 : int8
        Value of playing local domino index 0-6 from current player's hand.
...
# Remaining masks (4 players × 7 bits each)
REMAINING_BITS = 7
REMAINING_MASK = 0x7F
