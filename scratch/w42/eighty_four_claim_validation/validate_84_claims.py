...
This stays in scratch and validates measurable static claims from Winning 42
...
OUT = ROOT / "scratch" / "w42" / "eighty_four_claim_validation"

_WANDB_UTILS_PATH = ROOT / "scratch" / "w42" / "wandb_utils.py"
...
def main() -> None:
    ...
    config = {
        "bead_id": "t42-csw6.21",
        "git_sha": sha,
        "data_manifest": "scratch/w42/eighty_four_claim_validation/summary.json",
    ...
    wandb_run = init_wandb(
        ...
        tags=["w42", "winning42", "strategy-validation", "eighty-four", "scratch", "t42-csw6.21"],
    )
    ...
    summary = {
        ...
        "artifacts": {
            "bidder_shape_summary_csv": "scratch/w42/eighty_four_claim_validation/bidder_shape_summary.csv",
            "trump_count_distribution_csv": "scratch/w42/eighty_four_claim_validation/trump_count_distribution.csv",
            "example_cases_csv": "scratch/w42/eighty_four_claim_validation/example_cases.csv",
            "defender_last_trick_weapon_distribution_csv": "scratch/w42/eighty_four_claim_validation/defender_last_trick_weapon_distribution.csv",
            "defender_same_suit_pair_distribution_csv": "scratch/w42/eighty_four_claim_validation/defender_same_suit_pair_distribution.csv",
            "claim_summary_csv": "scratch/w42/eighty_four_claim_validation/claim_summary.csv",
            "abandonment_trigger_table_csv": "scratch/w42/eighty_four_claim_validation/abandonment_trigger_table.csv",
            "claim_ledger_delta_json": "scratch/w42/eighty_four_claim_validation/claim_ledger_delta.json",
            "summary_json": "scratch/w42/eighty_four_claim_validation/summary.json",
        },
    ...
    ledger_delta = {
        ...
        "provenance": {
            "commands": [
                "python scratch/w42/eighty_four_claim_validation/validate_84_claims.py --wandb-mode online"
            ],
