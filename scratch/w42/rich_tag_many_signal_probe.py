...
This script is w42-owned scratch code. It keeps the raw/v0 split, core encoder
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", default="scratch/w42/rich_tag_many_signal_probe")
