...
OUT = ROOT / "scratch" / "w42" / "bidder_sequencing_claim_validation"
METRICS = ROOT / "scratch" / "w42" / "v0_strategy_tags_baseline" / "metrics.json"
RUN = ROOT / "scratch" / "w42" / "v0_strategy_tags_baseline" / "run.json"
RAW_METRICS = ROOT / "scratch" / "w42" / "raw_public_state_baseline" / "metrics.json"
EQ_SUMMARY = ROOT / "scratch" / "w42" / "eq_n10_comparison_slice" / "summary.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "artifacts": {
            "summary_json": "scratch/w42/bidder_sequencing_claim_validation/summary.json",
            "claim_summary_csv": "scratch/w42/bidder_sequencing_claim_validation/claim_summary.csv",
            "bucket_proxy_stats_csv": "scratch/w42/bidder_sequencing_claim_validation/bucket_proxy_stats.csv",
            "claim_ledger_delta_json": "scratch/w42/bidder_sequencing_claim_validation/claim_ledger_delta.json",
        },
    }
