...
This is intentionally a bead-local runner. It reuses the existing w42 scratch
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", default="scratch/w42/multi_seed_larger_eval_replication")
