/**
 * Hints layer - Annotate actions with educational hints.
 *
...
export const hintsLayer: Layer = {
  ...
  /**
   * Annotate actions with educational hints.
   *
   * Analyzes game state to generate contextual hints and adds them as action metadata.
