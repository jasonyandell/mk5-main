/**
 * Shared helper functions for layer implementations.
 *
 * These pure utility functions are used by layers to avoid duplication
 ...
 *
 * This shared helper eliminates code duplication across 4 layers.
 *
