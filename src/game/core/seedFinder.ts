...
export { findCompetitiveSeed, testSeedWinRate } from '../ai/gameSimulator';
...
export async function evaluateSeed(
  ...
  const { testSeedWinRate } = await import('../ai/gameSimulator');
...
export async function findBalancedSeed(
  ...
  const { findCompetitiveSeed } = await import('../ai/gameSimulator');
