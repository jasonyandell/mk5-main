 ...
 * - Base ruleset produces correct results alone
 * - Base + single ruleset composes correctly
 * - Base + multiple ruleSets compose correctly
...
import { composeRules, baseRuleSet, nelloRuleSet, plungeRuleSet, sevensRuleSet } from '../../../game/rulesets';
