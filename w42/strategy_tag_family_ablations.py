...
This is w42-owned research code. It reuses the rich-tag many-signal probe's
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--rich-metrics-path", default="w42/rich_tag_many_signal_probe/metrics.json")
    parser.add_argument("--output-dir", default="w42/strategy_tag_family_ablations")
    parser.add_argument(
        "--ablation-mode",
