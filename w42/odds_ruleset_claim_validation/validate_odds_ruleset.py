...
The script intentionally lives under w42: it enumerates double-six hands and
...
OUT_DIR = Path("w42/odds_ruleset_claim_validation")
...
def build_claim_entries(commit_sha: str, command: str) -> dict[str, object]:
    ...
    evidence = "w42/odds_ruleset_claim_validation/validation_summary.json"
...
def main() -> None:
    ...
    command = "python w42/odds_ruleset_claim_validation/validate_odds_ruleset.py"
