...
- [[topics/convention-aware-blueprint-search|convention-aware-blueprint-search]] — IDEATED, unbuilt, unselected SPARTA-style design; preserves Winning 42 as a sparse coordinated sender/receiver overlay, a sender × partner-reader × opponent-reader attribution, and a latent opponent-policy hypothesis rather than policy truth (active)
