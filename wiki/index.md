...
- [[entities/book-strategy-player|book-strategy-player]] — multi-step book-plan architecture, nine-algebra spec, coverage recording, and strategy-selector training route (design)
...
- [[entities/book-strategy-player|book-strategy-player]] — multi-step strategy framework with explicit lifecycle, nine algebras / ten laws, namespaced plan state, free counterfactual recording, and uncovered-region discovery hooks; resurrects Burl/Gus/Zeb roles (design)
