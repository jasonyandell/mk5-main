...
The catalog, split by kind. Every page in the wiki appears in exactly one
catalog file below; the linter (`scripts/wiki_lint.py`) enforces coverage.
...
- [[questions/open|open]] — live questions with raising shas
- [[questions/resolved|resolved]] — answered or closed-by-pivot, with receipts
