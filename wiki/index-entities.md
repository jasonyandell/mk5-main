...
- [[entities/table42|table42]] — four-seat online table on a Cloudflare Worker: engine HeadlessRoom replay + seat-token filtered views; Jason vs Claude with Opus-brained jeb partners (active)
