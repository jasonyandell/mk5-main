...
- [[entities/walt|walt]] — exact endgame information-set solver: best response vs a fixed field over exactly-enumerated worlds at ≤4 tiles; graded +3.00 marks/game over jud play with the field-exact caveat (#72); the W0/W1 ablation runs the gap decomposition as an experiment (term 2 carries 84.9% of the edge); ladder gated on the scar probe (#73); issue #71 (active)
