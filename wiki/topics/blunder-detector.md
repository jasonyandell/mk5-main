...
**v2 — student features only** (5373223): trained using only what is available at inference from the student's own outputs. This is what ships.
...
[[gus]] [[regret-eval]] [[detect-and-route]] [[v-pi-decoupling]] [[expected-q-value]]
