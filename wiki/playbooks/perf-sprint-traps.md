...
kind: playbook
first_seen: fbe798f
last_updated: forge (iter 22: ceiling-drift finding confirmed at scale — multi-hour-sprint ceiling fell below N=300 even with cohort cleanup active; cohort lever helps at small/medium N on a fresh system but does not defeat cumulative session pressure)
status: active
---
