...
kind: playbook
first_seen: fbe798f
last_updated: forge (iter 24: ceiling-drift reversibility CONFIRMED at scale — bf16 batch=8 cont N=100 cohort=50 ran clean through both cohorts at 13.79s/dec, matching iter 20's fresh-boot anchor exactly and beating iter 21's 15.35s/dec at the same config; inter-iter idle alone recovers the iter 21 regime without a reboot, no subprocess isolation needed at N=100)
status: active
---
