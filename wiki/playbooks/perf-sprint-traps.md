...
kind: playbook
first_seen: fbe798f
last_updated: ffc9ef1 (iter 18: mx.set_memory_limit guard is a SOFT GUIDELINE — does NOT convert silent jetsam to RuntimeError; N=50 ceiling drifts with cumulative system state)
status: active
---
