...
kind: playbook
first_seen: fbe798f
last_updated: forge (iter 23: ceiling drift is REVERSIBLE — single bf16 batch=5 cont N=50 ran clean after iter 22 collapse, +4.5% wall vs iter 14 fresh-boot baseline = within noise floor; inter-iter idle alone can recover the N=50 ceiling without a reboot)
status: active
---
