...
| What must the planning framework obey? | [[book-strategy-player]]'s nine algebras and ten laws |
...
the entire W42 leaf pile. Its nine-algebra specification turns the route into a
buildable contract: library union, arbitration, plan-state threading, fallback
equivalence, recording, and fact publication are no longer loose design choices.
