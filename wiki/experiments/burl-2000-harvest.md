...
- 43% of decisions had moved between buckets relative to the sequential baseline. Aggregate parity was a false pass — distribution-level errors cancelled.
