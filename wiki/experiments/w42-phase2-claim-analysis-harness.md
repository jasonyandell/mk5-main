...
| `w42/claim_analysis/registry.py` | built-in claim-spec registry: `GUS_TACTICAL_SPECS`, `BRANCH_ATLAS_SPECS`, `CHAMPION_SPECS` (6 each), selected via `specs_for_source_kind` |
