...
on the same [[game-context-qa]] corpus used for [[v4-adapter]]. It is published at
...
- **Training data**: same game-context Q&A corpus as [[v4-adapter]] (see [[game-context-qa]])
...
This is the decisive factor in the [[base-model-pivot-qwen]] decision.
