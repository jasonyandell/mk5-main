...
- report artifacts: `scratch/w42/eighty_four_claim_validation/`
...
| field | value |
|---|---|
| manifest path | `scratch/w42/eighty_four_claim_validation/summary.json` |
...
| generated by | `python scratch/w42/eighty_four_claim_validation/validate_84_claims.py --wandb-mode online --wandb-name t42-csw6.21-84-validation-corrected-s0042-f746b93` |
...
`scratch/w42/eighty_four_claim_validation/claim_ledger_delta.json`.
...
| validation script | `scratch/w42/eighty_four_claim_validation/validate_84_claims.py` | manual scratch script | scratch |
| summary | `scratch/w42/eighty_four_claim_validation/summary.json` | validation script | scratch |
| bidder shape table | `scratch/w42/eighty_four_claim_validation/bidder_shape_summary.csv` | validation script | scratch |
| trump distribution | `scratch/w42/eighty_four_claim_validation/trump_count_distribution.csv` | validation script | scratch |
| example cases | `scratch/w42/eighty_four_claim_validation/example_cases.csv` | validation script | scratch |
| defender weapon table | `scratch/w42/eighty_four_claim_validation/defender_last_trick_weapon_distribution.csv` | validation script | scratch |
| defender pair table | `scratch/w42/eighty_four_claim_validation/defender_same_suit_pair_distribution.csv` | validation script | scratch |
| abandonment trigger table | `scratch/w42/eighty_four_claim_validation/abandonment_trigger_table.csv` | validation script | scratch |
| claim summary | `scratch/w42/eighty_four_claim_validation/claim_summary.csv` | validation script | scratch |
| claim ledger delta | `scratch/w42/eighty_four_claim_validation/claim_ledger_delta.json` | validation script | scratch |
...
bd show t42-csw6.21
rg --files wiki scratch/w42 | rg -i 'w42|winning42|claim|ledger|detector|bucket|84|eighty|chapter|ch7|ch8|template|charter|lab'
...
cat scratch/w42/concept_bucket_regret_report/manifest.json
sed -n '1,80p' scratch/w42/concept_bucket_regret_report/concept_bucket_regret.csv
sed -n '1,240p' scratch/w42/strategy_tags_v1_map/detector_map.json
...
python scratch/w42/eighty_four_claim_validation/validate_84_claims.py --wandb-mode online --wandb-name t42-csw6.21-84-validation-corrected-s0042-f746b93
cat scratch/w42/eighty_four_claim_validation/summary.json
sed -n '1,80p' scratch/w42/eighty_four_claim_validation/bidder_shape_summary.csv
sed -n '1,80p' scratch/w42/eighty_four_claim_validation/defender_last_trick_weapon_distribution.csv
sed -n '1,80p' scratch/w42/eighty_four_claim_validation/defender_same_suit_pair_distribution.csv
```

Configs:

- `scratch/w42/eighty_four_claim_validation/summary.json`
